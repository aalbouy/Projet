...
public class Optionfinal extends JFrame {
    ...
    public Optionfinal() {
        ...
        JPanel JPanel_fond = new ImageFond("c://tennis.jpg");
        ...
        Balle.setForeground(Color.yellow);
        Balle.setFont(new java.awt.Font("Impact", 1, 24));
        Balle.setBackground(Color.black);
